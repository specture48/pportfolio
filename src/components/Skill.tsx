...
const Skill: FC<{ skill: ISkill }> = ({skill}) => {
    ...
    return (<div  className='flex  rounded-md hover:bg-gradient-to-r from-[#ff000055] to-[#6881cb55] transition-all duration-1000 flex-col p-10 text-white border-[1px]   '>
